...
git clone --depth 1 -b jazzy https://github.com/micro-ROS/micro_ros_setup.git
cd /prebuilt_ws && . /opt/ros/jazzy/setup.sh && rosdep init && rosdep update --rosdistro=jazzy
