...
def generate_launch_description():
    ...
    # Find path
    config_file_dir = os.path.join(get_package_share_directory("handy1_bringup"), "config")
    ...
    return LaunchDescription([
        ...
        # ),
        ExecuteProcess(
            # cmd=[['ros2 bag play ', '~/rosbag/post_rosbag2_2025_09_20-14_09_34 ', '--clock ']], 
            # cmd=[['ros2 bag play ', '~/rosbag/cityhall1_rosbag2_2025_09_20-12_47_42 ', '--clock ']], 
            cmd=[['ros2 bag play ', '~/rosbag/cityhall2_rosbag2_2025_09_20-14_49_38 ', '--clock ', '--start-offset ', '60 ']], 
            shell=True
        ),
