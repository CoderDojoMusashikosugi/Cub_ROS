...
def generate_launch_description():
    ...
    diag_config = PathJoinSubstitution([
        FindPackageShare('cub4_bringup'),
        'config',
        'diagnostics.yaml'
    ])

        # velodyneの起動
        # こちらは、minipc_launch_at_boot.launch.pyへ移動したため、コメントアウト
    ...
    # cub4_bringup_share_dir = ament_index_python.packages.get_package_share_directory('cub4_bringup')
    # velodyne_convert_params_file = os.path.join(cub4_bringup_share_dir, 'config', 'VLP32C-velodyne_transform_node-params.yaml')
