...
def kill_ign(event, context):
    ...
    system('sudo docker exec -u ubuntu cub_ros_rviz /bin/bash -c "pkill -INT -f ignition.launch.py && pkill -INT -f gazebo && pkill -INT -f ignition"')
...
def generate_launch_description():
    ...
    TURTLEBOT3_MODEL = getenv('TURTLEBOT3_MODEL')
